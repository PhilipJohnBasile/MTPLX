...
# Vision tower weights ship under one of two checkpoint prefixes. mlx-vlm's
# qwen3_5/qwen3_6 layout uses ``vision_tower.*``; HF's
# Qwen3_5MoeForConditionalGeneration layout (qwen3_5_moe multimodal
