...
def _tune_candidate_summary(
    ...
    *,
    ...
    verify_forward_calls = int(summary.get("verify_forward_calls") or verify_calls)
...
def _serve_deepseek_v4_mlxserve(
    ...
    *,
    ...
    """Launch the reviewed target-only DSV4 artifact through native mlx-serve."""
    ...
    if not quiet_json:
        ...
        _print_serve_start_line(
            "[4/6] Backend selected: native mlx-serve target-only AR"
        )
...
def _deepseek_v4_mlxserve_admission_error(
    *,
    ...
    """Render external-runtime admission failures without breaking JSON callers."""
    ...
    *,
    ...
    stats = {
        ...
        if generation_mode == GENERATION_MODE_AR
            ...
            getattr(out.stats, "verify_forward_calls", 0) or out.stats.verify_calls
        ),
